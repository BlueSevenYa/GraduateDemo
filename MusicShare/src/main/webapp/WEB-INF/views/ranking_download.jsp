				...
				<div class="g-bd">
					<div class="g-wrap p-prf">
						<dl class="m-proifo f-cb" id="head-box">
							<dt class="f-pr" id="ava">
								<img src="http://localhost:8080/resources/images/rankdownload.jpg" />
							</dt>
							<dd>
								<div class="clearfix"></div>
								...
								<div class="mm-btn">
									<a data-res-action="play" href="http://localhost:8080/music/ranking/download/play" class="u-btn2 u-btn2-2 u-btni-addply f-f1" hidefocus="true" title="播放">
										<i>
											<em class="ply">播放</em>
										</i>
									</a>
					...
					<div class="u-title u-title-1 f-cb" id="Header">
							...
							<div id="s-record" class="s-record">
								<div class="j-flag">
									<ul>
										<c:forEach items="${rankingvos}" var="rankingvo" varStatus="r">
											<li>
												<div class="hd">
													<span class="num">${r.index+1}.</span>
												</div>
												<div class="song">
													<div class="tt">
														<div class="ttc">
														<span class="txt">
															<a href="http://localhost:8080/song/listen?songid=${rankingvo.songid}" songid="${rankingvo.songid}" class="songclick">
																<b title="${rankingvo.songname}">${rankingvo.songname}</b>
															</a>
															<span class="ar s-fc8">
																<em>-</em>
																<span title="${rankingvo.singername}">
																	<a class="artist" href="http://localhost:8080/singer/show/${rankingvo.singerid}" hidefocus="true">${rankingvo.singername}</a>
																</span>
																<span class="s-time"><fmt:formatDate value="${rankingvo.status_date}" pattern="yyyy.MM.dd"/></span>
															</span>
													...
													<span class="s-time"><fmt:formatDate value="${rankingvo.status_date}" pattern="yyyy.MM.dd"/></span>
													<span class="s-time" style="margin-left:140px">${rankingvo.downloadtime}次</span>
												</div>
												<span>
												<a href="http://localhost:8080/song/listen?songid=${rankingvo.songid}"><img src="http://localhost:8080/resources/icon/play-button.png" /></a>
												<a href="javascript:void(0)" class="judgescore" songid="${rankingvo.songid}"><img src="http://localhost:8080/resources/icon/download.png" /></a>
												<a href="javascript:void(0)" title="收藏" class="shoucang" data-toggle="modal" data-target="#myModal" songid="${rankingvo.songid}"><img src="http://localhost:8080/resources/icon/box.png" /></a>
