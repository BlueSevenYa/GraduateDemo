        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="g-bd">
					<div class="g-wrap p-prf">
						<dl class="m-proifo f-cb" id="head-box">
							<dt class="f-pr" id="ava">
								<img src="http://localhost:8080/musicplat/picture/headpic/${userhome.userpicurl}" />
								<div class="btm">
									<a href="http://localhost:8080/change/head" class="change">更换头像</a>
								</div>
							</dt>
							<dd>
								<div class="name f-cb">
									<div class="f-cb">
										<div class="edit">
											<a href="http://localhost:8080/user/dealupdate" hidefocus="true" class="u-btn2 u-btn2-1">
												<i>编辑个人资料</i>
											</a>
										</div>
										<h2 id="j-name-wrap" class="wrap f-fl f-cb">
											<span class="tit f-ff2 s-fc0 f-thide">昵称:${userhome.nickname}</span>
										</h2>
									</div>	
								</div>
								<div class="inf s-fc3">
									<span>用户名：${userhome.username}</span>
								</div>
								<div class="inf s-fc3">
									<span>性别：${userhome.sex}</span>
								</div>
								<div class="inf s-fc3">
									<span>年龄：<fmt:formatDate value="${userhome.birthday }" pattern="yyyy-MM-dd"/></span>
								</div>
								<div class="inf s-fc3">
									<span>介绍：${userhome.describle}</span>
								</div>
								<div class="inf s-fc3">
									<span>所在地区：${userhome.place}</span>
								</div>
								<div class="inf s-fc3">
									<span>我的积分：${userhome.userscore}</span>
								</div>
							</dd>
						</dl>
					</div>
					...
					<div class="u-title <!--u-title-1 f-cb-->" id="Header">
						...
						<div class="resent-grid-img recommended-grid-img">
							<a href="http://localhost:8080/love/songs/${userhome.userid}"><img src="http://localhost:8080/resources/images/like.jpg" alt="" /></a>
						</div>
	        ...
	        <div class="u-title u-title-1 f-cb" id="Header">
							...
							<div id="s-record" class="s-record">
								<div class="j-flag">
									<ul>
										<c:forEach items="${sharesongforuser}" var="sharesong" varStatus="s">
										<li>
											<div class="hd">
											...
											<div class="song">
												<div class="tt">
													<div class="ttc">
														<span class="txt">
															<a href="http://localhost:8080/song/listen?songid=${sharesong.songid}" songid="${sharesong.songid}" class="songclick">
																<b title="${sharesong.songname}">${sharesong.songname}</b>
															</a>

															<span class="ar s-fc8">
																<em>-</em>
																<span title="${sharesong.singername}">
																	<a class="artist" href="http://localhost:8080/singer/show/${sharesong.singerid}" hidefocus="true">${sharesong.singername}</a>
																</span>	
													...
													<span class="s-time"><fmt:formatDate value="${sharesong.status_date}" pattern="yyyy.MM.dd"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<c:choose>
														<c:when test="${sharesong.isyuanchuang=='是'}">
															原创音乐
														</c:when>
														<c:otherwise>
															非原创音乐
											...
											<span>
												<a href="http://localhost:8080/song/listen?songid=${sharesong.songid}"><img src="http://localhost:8080/resources/icon/play-button.png" /></a>
												<a href="javascript:void(0)" class="judgescore" songid="${sharesong.songid}"><img src="http://localhost:8080/resources/icon/download.png" /></a>
												<%--http://localhost:8080/song/download/${song.songid}--%>
												<a href="javascript:void(0)" title="收藏" class="shoucang" data-toggle="modal" data-target="#myModal" songid="${sharesong.songid}"><img src="http://localhost:8080/resources/icon/box.png" /></a>
											</span>
