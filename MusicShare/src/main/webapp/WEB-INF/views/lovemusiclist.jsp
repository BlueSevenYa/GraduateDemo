					...
					<div class="g-wrap p-prf">
						<dl class="m-proifo f-cb" id="head-box">
							<dt class="f-pr" id="ava">
								<img src="http://localhost:8080/resources/images/like.jpg" />
							</dt>
							<dd>
								<div class="clearfix"></div>
								<div class="u-title u-title-1">
									<span><c:choose>
										<c:when test="${sessionScope.get('user').userid==lovemusic.userid}">
											我
										</c:when>
										<c:otherwise>
											ta
								...
								<div class="mm-btn">
									<a data-res-action="play" href="http://localhost:8080/listen/songs/${lovemusic.userid}" class="u-btn2 u-btn2-2 u-btni-addply f-f1" hidefocus="true" title="播放">
										<i>
											<em class="ply">播放</em>
										</i>
									</a>
										...
										<li>
											...
											<div class="song">
												...
												<div class="tt">
													...
													<div class="ttc">
														<span class="txt">
															<a href="http://localhost:8080/song/listen?songid=${favorite.songid}" songid="${favorite.songid}" class="songclick">
													...
													<span class="s-time"><fmt:formatDate value="${favorite.status_date}" pattern="yyyy.MM.dd"/></span>
											</div>
											<span>
