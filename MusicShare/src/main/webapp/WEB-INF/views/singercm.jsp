  ...
  <body>
	...
	<div id="page_div" style="position:absolute;right:300px;bottom:-200px;">
		...
		<ul class="pagination">
			...
			<li><a href="http://localhost:8080/singer/chinese/male?pageNum=${pagehelper.firstPage}&pageSize=${pagehelper.pageSize}">&lt;&lt;</a></li>
			<li><a href="http://localhost:8080/singer/chinese/male?pageNum=${pagehelper.prePage}&pageSize=${pagehelper.pageSize}">&lt;</a></li>
			</c:if>
			<c:forEach items="${pagehelper.navigatepageNums}" var="navigatepageNum">

				<c:if test="${navigatepageNum==pagehelper.pageNum}">
					<li class="active"><a href="http://localhost:8080/singer/chinese/male?pageNum=${navigatepageNum}&pageSize=${pagehelper.pageSize}">${navigatepageNum}</a></li>
				</c:if>
				<c:if test="${navigatepageNum!=pagehelper.pageNum}">
					<li><a href="http://localhost:8080/singer/chinese/male?pageNum=${navigatepageNum}&pageSize=${pagehelper.pageSize}">${navigatepageNum}</a></li>
				</c:if>
			</c:forEach>
			<c:if test="${!pagehelper.isLastPage}">
				<li><a href="http://localhost:8080/singer/chinese/male?pageNum=${pagehelper.nextPage}&pageSize=${pagehelper.pageSize}">&gt;</a></li>
				<li><a href="http://localhost:8080/singer/chinese/male?pageNum=${pagehelper.lastPage}&pageSize=${pagehelper.pageSize}">&gt;&gt;</a></li>
			</c:if>
		</ul>
